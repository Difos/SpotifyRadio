...
describe("#Routes - test site for api response", () => {
  ...
  test("GET / should able to redirect to home page", async () => {
  ...
  test(`GET /controller should response with ${pages.homeHTML} file stream`, async () => {
    const params = TestUtil.defaultHandleParams();
    params.request.method = "GET";
  ...
  test(`POST /unknown - given an inexistent rout it should response with 404`, async () => {
    const params = TestUtil.defaultHandleParams();
  ...
  describe("exceptions", () => {
    ...
    test("given and error it should respond with 500", async () => {
        const params = TestUtil.defaultHandleParams();
        params.request.method = "GET";
        params.request.url = "/index.png";
        jest.spyOn(
